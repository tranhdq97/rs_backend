...
urlpatterns = [
    ...
    path("api/customer/", include("staff.customer.urls"), name="customer"),
    path("api/staff/", include("staff.staff.urls"), name="staff"),
    path("api/menu/", include("staff.menu.urls"), name="menu"),
    path("api/table/", include("staff.table.urls"), name="table"),
    path("api/order/", include("staff.order.urls"), name="order"),
    path("api/order_item/", include("staff.order_item.urls"), name="order_item"),
    path("api/file-management/", include("staff.file_management.urls"), name="file management"),
]
